...
let ReuniaoController = class ReuniaoController {
    constructor(service) {
        ...
        this.logger = new common_1.Logger('ReuniaoController');
    }
    async getAll() {
...
], ReuniaoController.prototype, "getAll", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UsePipes)(new common_1.ValidationPipe({ transform: true })),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [reuniao_dto_1.ReuniaoDto]),
    __metadata("design:returntype", Promise)
], ReuniaoController.prototype, "save", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], ReuniaoController.prototype, "getById", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], ReuniaoController.prototype, "detelar", null);
ReuniaoController = __decorate([
    (0, common_1.Controller)('/api/reuniao'),
